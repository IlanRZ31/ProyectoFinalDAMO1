...
class MedicamentoAdapter(private val medicamentoList: List<String>, currentView: View):RecyclerView.Adapter<MedicamentoAdapter.MediacamenoHolder>(){
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MediacamenoHolder {
        val layoutInflater = LayoutInflater.from(parent.context)
        return MediacamenoHolder(layoutInflater.inflate(R.layout.recycler_medicamentos, parent, false))
    }
    ...
    inner class MediacamenoHolder(private var view: View): RecyclerView.ViewHolder(view){
        ...
        fun load(medicina: String) {
            ...
            fragMedicamento.setOnClickListener {
                Navigation.findNavController(view).navigate(R.id.acMostrarMedicamentosEditarMedicamentos)
            }
        }
    }
